...
const HomeScreen = () => {
  ...
  // Get Products Data from fakr API
  useEffect(() => {
        ...
        >
          <View style={{ marginBottom: 8 }}>
            ...
            <Text style={{ marginTop: 5, fontSize: 16, color: "gray" }}>
              Select a delivery loaction to see product availabilty and delivery
              options
            </Text>
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            ...
            >
              ...
              <View
                style={{ flexDirection: "row", alignItems: "center", gap: 5 }}
              >
                <AntDesign name="earth" size={21} color="#0066b2" />
                <Text style={{ color: "#0066b2", fontWeight: "400" }}>
                  Deliver outside Egypt
                </Text>
              </View>
            </View>
          </View>

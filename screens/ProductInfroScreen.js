    ...
    >
      ...
      <View style={{ padding: 10 }}>
        ...
        <Text style={{ color: "#00CED1" }}>
          FREE delivery Tomorrow by 3 PM Order within 10 hrs
        </Text>
        <View
          style={{
            flexDirection: "row",
        ...
        >
          ...
          <Text style={{ fontSize: 15, fontWeight: "500" }}>
            Deliver to Yousef - Obour 020232
          </Text>
        </View>
      </View>
...
export default ProductInfroScreen;
